...
```
- Con este comando se pide que el tamaño de los paquetes tengan una longitud tengan 32 bytes de longitud, para ello usamos el parámetro --mtu, y a continuación el tamaño de los paquetes enviados.
